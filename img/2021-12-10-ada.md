...
TALK ABOUT THE RESCALING OF THE DATA - WHY WAS THIS NECESSARY, HOW DID WE DO IT? - RAPHAEL (be expressive here).
Raphael: you say "Note that we will refer to the variable "intention_mean" by intention vote and "weekly_occurrences_rescaled" by media coverage." This is not super clear to me, can you expand/describe.
