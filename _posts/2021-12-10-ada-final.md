...
And now we can use these time series given above to calculate the Spearman correlations with the voting intentions, and this would give us different insights on what we did previously (in the baseline and sentiment analysis). What could be also interesting is to run a regression analysis using **sentiment analysis** and **topic_weight** as covariates.
...
We added as a final section, an expansion of our correlation analysis via topic modeling. This would be a good approach to have different insightful results not previously visible in the two correlation studies performed above.
