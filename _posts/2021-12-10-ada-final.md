...
(**EXPLAIN HERE PURPOSE OF THE SECTION**)
...
We present in the illustration above three categories: statistical tests in which we have clear significance where p<0.05 (marked in dark blue), statistical tests in which we observed "weak significance" where p is between 0.05 and 0.1 (marked in light blue) and finally statistical tests that do not present any significance, where p>0.1 (marked in red).
